        ...
        <Card className="border-0 shadow-elegant bg-white dark:bg-slate-950 rounded-3xl overflow-hidden">
            ...
            <CardContent className="p-6 space-y-6">
                ...
                <div className="pt-4 border-t border-slate-100 dark:border-slate-900 flex flex-col sm:flex-row items-center justify-between gap-4">
                    <Button variant="ghost" onClick={onClear} className="rounded-2xl hover:bg-slate-100 dark:hover:bg-slate-900 font-semibold text-muted-foreground hover:text-slate-900">
                        <X className="h-4 w-4 mr-2" />
                        Reset all filters
                    </Button>

                    <div className="flex items-center gap-1.5 p-1.5 bg-slate-100 dark:bg-slate-900 rounded-2xl">
                        <Button
