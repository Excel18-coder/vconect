...
class MessageService {
  ...
  async getUserMessages(userId, filters = {}) {
    ...
    if (conversation_with) {
      ...
      messages = await messageRepository.getConversation(userId, parseInt(conversation_with), {
  ...
  async replyToMessage(parentMessageId, senderId, replyData) {
    ...
    const receiver_id =
      parentMessage.sender_id === senderId ? parentMessage.receiver_id : parentMessage.sender_id;
