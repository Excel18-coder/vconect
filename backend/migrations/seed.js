  ...
  try {
    ...
    const categories = [
      ...
      },
      {
        ...
        slug: "housing",
        description:
          "Real estate, rentals, property sales, and housing services",
      ...
      },
      {
        ...
        slug: "transport",
        description:
          "Transportation services, vehicle sales, and travel options",
    ...
    const result =
      await sql`SELECT name, slug, description FROM categories ORDER BY name`;
